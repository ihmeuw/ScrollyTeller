...
```
* Optionally override the CSS for your chart if ```useDefaultGraphCSS``` is set to false in the constructor. See ```SectionExampleChart.js``` and ```extendScrollyGraphExample.scss``` for an example.
